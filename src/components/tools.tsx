    ...
    >
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 mb-16">
        {tools.map((tool, index) => (
          <li
            key={index}
            className="flex flex-col text-[#111111] text-center outline outline-1 outline-[#111111] bg-[#EDE8DC] items-center m-1 p-3 rounded-sm transition ease-in-out duration-150"
          >
            <Image
              src={tool.imageUrl}
              alt={tool.alt}
