    ...
    <section id="home" className="scroll-mt-[100rem]">
      <div className="flex justify-end items-end flex-col my-20">
        ...
        >
          ...
          <h2 className="text-md sm:text-xl">Aspiring Front-End Developer</h2>
        </motion.div>
        <motion.div
        ...
        >
          <a
            ...
            target="_blank"
            className="transition duration-100 ease-in-out rounded-sm hover:bg-[#6E99C4] hover:scale-[1.03]"
