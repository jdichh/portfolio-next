        ...
        <article>
          ...
          <section id="section1">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/threejs.webp"
          ...
          <section id="section3">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/vaporwave.webp"
            ...
            <p className="leading-7 mb-8 opacity-90">
              ...
              some post-processing effects like blur and a CRT filter, and some
          ...
          <section id="section4">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/light-directional.png"
          ...
          <section id="section5">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/skybox-trial.png"
          ...
          <section id="section7">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/skybox.webp"
                alt="Skybox texture"
                width={IMAGE_DIMENSIONS}
                height={IMAGE_DIMENSIONS}
                quality={IMAGE_QUALITY}
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/synthwave_act1.png"
          ...
          <section id="section8">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/issues.png"
            ...
            <p className="leading-7 mb-8 opacity-90">
              <strong>
                Don't mind the sun and the post-processing effects like bloom
                and the CRT filter, let's focus on the terrain's issues for now.
              </strong>
            </p>
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/displacementmap.png"
          ...
          <section id="section9">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/displacementmap_issues.png"
          ...
          <section id="section10">
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/sun.webp"
            ...
            <figure className={`bg-[${FIGURE_BG}] p-3 rounded-md my-8 mx-auto`}>
              <Image
                src="/article-images/my-shenanigans-in-3d/synthwave_act2.png"
